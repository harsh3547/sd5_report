...
class sd5_2_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        print '********************************* report called sd5'
        print cr,uid,name,context
        super(sd5_2_report, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.report_2_sd_mod','hr.contract','addons/sd5_report/report/report_2_sd.mako',
    parser=sd5_2_report)
